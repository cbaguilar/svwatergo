...
function ROSystem({ md, pipe_info }) {
    ...
    return (
        <>
            ...
            />
            <ValveIndicator x="793" y="100" innerText="AV1" flow={av1} on_click={md.get("inletrun", "on_click")} />
            <DoubleFilter
                x="932.5"
                y="118"
                innerText1="20"
...
function SantaTeresaSchematic({ md }) {
...
export default SantaTeresaSchematic;
